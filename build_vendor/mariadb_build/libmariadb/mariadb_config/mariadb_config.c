...
#define LIBS    "-L%s//mariadb/ -lmariadb"
#define LIBS_SYS "-ldl -lm -lssl -lcrypto"
#define CFLAGS  INCLUDE
#define VERSION "10.8.8"
#define CC_VERSION "3.3.17"
#define PLUGIN_DIR "%s//mariadb/plugin"
#define SOCKET  "/tmp/mysql.sock"
#define PORT "3306"
#ifdef HAVE_TLS
#define TLS_LIBRARY_VERSION "OpenSSL 3.5.4"
#else
#define TLS_LIBRARY_VERSION ""
#endif
#define PKG_INCLUDEDIR "%s/include/mariadb"
#define PKG_PLUGINDIR "%s//mariadb/plugin"
#define PKG_LIBDIR "%s//mariadb"

#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/usr/local//mariadb/ -lmariadbd -ldl -lm -lssl -lcrypto"
#endif
